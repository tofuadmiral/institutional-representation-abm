...
%  headline findings, and takeaways. Three-column layout on a 25pt type scale.
% ============================================================================
...
configuration toggles. Headline results at $N=200$ seeds per
(scenario, institution) cell with $95\%$ bootstrap CIs (parameter sweeps
at $N=100$).
}
...
\block{Finding 1a: hung parliaments still legislate}{%
\centering
...
\raggedright
\large
Fragmentation makes government formation impossible, yet passage
continues: letting a hung parliament's MPs vote personally keeps
parliamentary legislation at $46.4\%$, indistinguishable from
...
\begin{enumerate}\setlength\itemsep{2.5mm}
    \item \textbf{Opposition cohesion drives the collapse.}
...
\large
\begin{itemize}\setlength\itemsep{1.5mm}
    \item Python 3.13, Mesa 2.x, MIT-licensed
    \item $80$ automated tests, GitHub Actions CI
