...
failure, party discipline, and committee gatekeeping. These mechanisms
operate simultaneously in any real legislature, so observational studies
struggle to separate their contributions. We present an agent-based model that compares four democratic
...
\begin{center}
    ...
    reports the full passage-rate table; Section~\ref{sec:results:ablation}
    attributes the collapse to party discipline.
    \end{minipage}
\end{center}
