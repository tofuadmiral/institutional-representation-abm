...
passage to $0.05\%$. The fragmentation pathology is therefore a discipline
phenomenon operating through the opposition side, not a coalition-formation
failure per se. Second, disabling discipline restores fragmented passage to
...
initiatives succeed at below $1\%$ \citep{noble2018}.
...
yet the legislatures elected by these publics operate at order-of-magnitude
different passage rates. The natural explanation is the rules. But
...
obstruction it collapses to $0.05\%$. The fragmentation pathology is
therefore a \emph{discipline} phenomenon operating through the opposition
side --- not a coalition-formation failure per se. Second
(\S\ref{sec:results}.4), the no-discipline ablation restores parliamentary
...
legislates at all. Third (\S\ref{sec:results}.5), the passage--representation
...
$(+29\text{pp})$ over republican is highly significant (Welch's $t = 38.9$,
$p < 10^{-200}$; Cohen's $d = 2.88$).
...
But which ingredient of fragmentation does the collapsing? Formation failure
...
through minority and caretaker cabinets, while polarised anti-system blocs
produce legislative deadlock.
...
The same analysis on the fragmented scenario confirms the num-parties
...
government exists), which cross-validates the attribution. The rescue
...
dependence. This reading is consistent with \citet{strom1984, strom1990}'s
demonstration that minority governments are rational, functioning cabinet
solutions rather than instability artifacts --- our personal-vote variant is
a stylised version of their issue-by-issue-majority world --- and with
\citet{shugart1992}'s typology of semi-presidential variants.

The obstruction side of the decomposition has older roots.
\citet{sartori1976}'s anti-system parties --- blocs defined by opposition to
